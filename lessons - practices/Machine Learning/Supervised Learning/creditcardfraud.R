...
tsne <- Rtsne(X, dims = 2, perplexity=42, verbose=TRUE, max_iter = 500,check_duplicates = FALSE)
exeTimeTsne<- system.time(Rtsne(X, dims = 2, perplexity=42, verbose=TRUE, max_iter = 500,check_duplicates =FALSE))

plot(tsne$Y, t='n', main="tsne")
text(tsne$Y, labels=Y, col=colors)
